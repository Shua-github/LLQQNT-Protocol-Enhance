    ...
    plugins: [
      cp({
        targets: [
          ...
          { src: './src/napcat-protocol-packet/Moehoo/*', dest: 'dist/moehoo/' },
          // { src: './src/napcat-protocol-packet/MoeHoo.linux.x64.node', dest: 'dist/moehoo/' },
          // { src: './src/napcat-protocol-packet/MoeHoo.win32.x64.node', dest: 'dist/moehoo/' },
        ],
      }),
    ],
  },
